...
//  GratefulMoments
//
//  Created by Tejeshwer Singh on 23/11/25.
//
    ...
    func unlockBadges(newMoment: Moment) throws {
        ...
        for badge in lockedBadges {
            ...
            case .firstEntry where moments.count >= 1,
                    ...
                    .shutterbug where moments.count(where: { $0.uiImage != nil }) >= 3,
                    .expressive where moments.count(where: { $0.uiImage != nil && !$0.note.isEmpty }) >= 5,
